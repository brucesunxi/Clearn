...
export const metadata: Metadata = {
  ...
  description: 'Raise a cute panda companion in PandaHan. Consistent learning makes your pet grow! 在 PandaHan 中养一只可爱的熊猫伙伴，坚持学习就能让它成长！',
  alternates: {
