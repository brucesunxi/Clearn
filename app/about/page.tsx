...
export const metadata: Metadata = {
  title: 'About Us 关于我们',
  description:
    'Panda Chinese is a free Chinese self-study tool for overseas Chinese children. Self-paced vocabulary, reading, and listening practice with gamified learning. 熊猫汉语是为海外华裔儿童打造的免费中文自学工具，包含词汇练习、分级阅读、听力口语等自学模块。',
  alternates: {
    canonical: 'https://pandahan.xyz/about',
  },
  openGraph: {
    title: 'About Us 关于我们 - Panda Chinese 熊猫汉语',
    description:
      'Learn about Panda Chinese, a free self-study tool for overseas Chinese children.',
  },
}
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Panda Chinese is a self-study tool built for overseas Chinese children and their families.
          ...
          <p className="text-gray-600 leading-relaxed mt-3">
            熊猫汉语是为海外华裔家庭打造的中文自学工具。我们相信学习中文应该是有趣、
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Panda Chinese is a self-study tool, not a school or tutoring service. We do not
          ...
          <p className="text-gray-600 leading-relaxed mt-3">
            熊猫汉语是自学工具，不是培训机构。我们不提供直播课程、预约课程、
